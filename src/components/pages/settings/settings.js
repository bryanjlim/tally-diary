...
class Settings extends Component {
  constructor(props) {
    ...
    this.closeSuccessImportSnackBar = this.closeSuccessImportSnackBar.bind(
      this
    );
  ...
  updateUserProperties(e) {
    ...
    DriveHelper.updateFile("0", updatedProperties)
      .then(() => {
  ...
  exportData(e) {
    ...
    var blob = new Blob([JSON.stringify(this.props.diaryEntryStore.entries)], {
      type: "text/json"
    });
      ...
      return (
        <div>
          ...
          <Snackbar
            ...
            message={
              <span>
                Note: downloads only work on our tallydiary.com web app
              </span>
            }
            action={[
              <IconButton
          ...
          <Snackbar
            ...
            message={
              <span>
                There was an error saving your settings. Error:{" "}
          ...
          <Snackbar
            ...
            message={
              <span>There was an error exporting your diary entries</span>
            }
            action={[
              <IconButton
                key="close"
          ...
          <Snackbar
            ...
            message={
              <span>Diary entries from json file successfully added.</span>
            }
            action={[
              <IconButton
                key="close"
