        ...
        return (
            <div className={classes.innerContainer}> 
                <h1 className={classes.title}>Welcome, {this.state.firstName}!</h1>
                    ...
                    <Card className={classes.card}>
                        <div className={classes.privacy}><i><b className={classes.boldNote}>Note: </b>This information is stored in your Google Drive's reserved application folder, only accessible by the Tally Diary app. Tally Diary will never, ever store your data on its own servers.</i></div>
                    </Card>
            </div> 
        );
    }
