...
|---|---|---|---|
| `phone-*` | 1170×2532 | Google Play phone | add-entry, timeline, entry-detail, insights |
| `phone-65in-*` | 1284×2778 | App Store iPhone 6.5" | same four |
| `tablet-*` | 2048×2732 | App Store iPad 12.9" / Play tablet | same four |

Suggested order in the listing: **timeline → insights → add-entry → entry-detail** (lead with the fullest-looking screens).
